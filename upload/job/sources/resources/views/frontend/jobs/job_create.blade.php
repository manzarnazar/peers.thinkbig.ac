...
<div class="page-wrap">
    <div class="blog-header nblog_header  j_head radius-8 mb-3" >
        ...
        <div class="btn-inline ">
            <a href="{{route('create.job')}}" class="btn common_btn "> <i class="fa fa-circle-plus me-2"></i>{{ get_phrase('Create Job') }}</a>
        ...
        <div class="create-article">
            ...
            <form action="{{ route('job.store') }}" class="form_sel" method="POST" enctype="multipart/form-data">
                ...
                <div class="inline-btn mt-3">
                    <button type="submit" class="btn common_btn w-100">{{ get_phrase('Create Job Post') }}</button>
                </div>
            </form>
        </div>
    </div>
