...
<div class="content-area single-content-list p-20 EjobPay  payout" >
    ...
    <div id="printableDiv">
        <table class="table table-borderless" >
            ...
            <tbody>
                ...
                @foreach($payment_history as $key => $list)
                <tr class="single-row table-light light-row job_ow job_payment">
                    <th scope="row">
                    ...
                    <td>
                        <div class="single-cell">
                            <a href="{{ route('job.single.details', $list->id) }}" target="_blank" class="cell-item item">
                                <p>{{ $list->title }}</p>
                            </a>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="single-cell">
                            <div class="cell-item">
                                <span class="eBadge"> {{ date('Y-m-d', strtotime($list->start_date)) }} </span>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="single-cell">
                            <div class="cell-item">
                                <p class="text-center">{{ $list->paid_amount }}</p>
                            </div>
                        </div>
                    </td>
                </tr>
