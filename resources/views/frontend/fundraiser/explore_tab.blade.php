    ...
    <div class="row">
        ...
        <div class="col-lg-12 ">
            <div class="bg-white radius-8 p-20 mb-12 blog-type res_funrai ">
                   ...
                   <h3 class="text_16">{{get_phrase('Popular Campaign')}}</h3>
                {{-- @else
                <h3></h3> --}}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="blog-card fund_card">
                            <div class="card custom_card">
                                ...
                                <div class="card-img">
                                    @if ($row->cover_photo != '')
                                     <a href="{{ route('fundraiser.profile', $id) }}">  <img src="{{ asset('assets/frontend/images/campaign/' . $row->cover_photo) }}"
                                    ...
                                    <div class="card-donate">
                                        <img src="{{ asset('assets/frontend/css/fundraiser/images/fundraiser/donate.svg') }}"
                                            alt="donate">
                                        <p class="donate-count">{{ $goal_amount }}</p>
                                    </div>
                                </div>
                                <div class="card-body">
...
@endif
        ...
        @if ($animal->count() > 0)
            <div class="col-lg-12  ">
                ...
                <div class="bg-white radius-8 p-20 mb-12 justify-content-between blog-type res_funrai">
                    <h3 class="text_16">{{get_phrase('Animals Campaign')}}</h3>
                {{-- </div> --}}
            {{-- </div> --}}
            <!-- Single Blog Card -->
           <div class="row">
        ...
        @if ($culture->count() > 0)
            <div class="col-lg-12">
                ...
                <div class="bg-white radius-8 p-20 mb-12  blog-type res_funrai">
                    <h3 class="text_22">{{get_phrase('Arts And Culture Campaign')}}</h3>
                {{-- </div>
            </div> --}}
            <!-- Single Blog Card -->
            <div class="row">
        ...
        @if ($business->count() > 0)
            <div class="col-lg-12">
                ...
                <div class="bg-white radius-8 p-20 mb-12 res_funrai blog-type ">
                    <h3 class="text_22">{{get_phrase('Business Campaign')}}</h3>
                {{-- </div>
            </div> --}}
            <!-- Single Blog Card -->
                <div class="row">
        ...
        @if ($community->count() > 0)
            <div class="col-lg-12">
                ...
                <div class="bg-white radius-8 p-20 mb-12 res_funrai blog-type">
                    <h3 class="text_22">{{get_phrase('Community & Social Action Campaign')}}</h3>
                {{-- </div>
            </div> --}}
            <!-- Single Blog Card -->
              <div class="row">
        ...
        @if ($crisis->count() > 0)
            <div class="col-lg-12">
                ...
                <div class="bg-white radius-8 p-20 mb-12  res_funrai blog-type">
                    <h3 class="text_22">{{get_phrase('Crisis Relief Campaign')}}</h3>
                {{-- </div>
            </div> --}}
            <!-- Single Blog Card -->
                 <div class="row">
        ...
        @if ($education->count() > 0)
            <div class="col-lg-12">
                ...
                <div class="bg-white radius-8 p-20 mb-12 res_funrai blog-type">
                    <h3 class="text_22">{{get_phrase('Education Campaign')}}</h3>
                {{-- </div>
            </div> --}}
            <!-- Single Blog Card -->
               <div class="row">
