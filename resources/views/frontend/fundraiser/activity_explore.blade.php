...
@if ($fundraiser_explore->count() > 0)
    <div class="blog-area fun_activity mb-0">
        <div class="row">
            <div class="col-lg-12 ">
                <div class="bg-white radius-8 p-20 mb-12 blog-type res_funrai">
                    <h3 class="text_22">{{get_phrase('In Progress')}}</h3>
               ...
               <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 ">
                        <div class="blog-card fund_card">
                            <div class="card fc_card custom_card">
                                <div class="card-img h-auto">
                                    @if ($row->cover_photo != '')
                                    ...
                                    <div class="donate_card_1">
                                        <a class="w-100 d-flex justify-content-center" href="javascript:void(0)" id="dropdownMenuButton1"
                                        ...
                                        <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li>
                                                <a href="{{ route('fundraiser.edit', ['id' => $id]) }}"
                                                    class="dropdown-item btn btn-primary btn-sm h-auto mt-0"><i
                                            ...
                                            <li>
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="dropdown-item btn btn-primary btn-sm h-auto mt-0"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-raised-area d-flex justify-content-between">
                                        <p class="pera_text">{{get_phrase('Raised :')}} <span
                                                class="text_purple">{{ currency($raised_amount) }}</span>
                                        </p>
                                        <p class="pera_text">{{get_phrase('Goal :')}} <span
                                                class="text_green">{{ currency($goal_amount) }}</span>
                                        </p>
                                    </div>
                                    <div class="in-process-btn pro w-100">
                                        <a href="javascript:void(0)" class=" custom-btn-1 btn mb-1"
                                        ...
                                        @if ($row->status == 0)
                                            <a href="{{ route('fundraiser.status', ['id' => $id]) }}"
                                                class="btn mt-0 custom-btn-3">{{get_phrase('Active')}}</a>
                                        @else
                                            <a href="{{ route('fundraiser.status', ['id' => $id]) }}"
                                                class="btn mt-0 btn_1 disable_btn">{{get_phrase('Disable')}}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@if ($fundraiser_complete->count() > 0)
    <div class="blog-area">
        <div class="row">
            <div class=" col-lg-12">
                <div class="bg-white radius-8 p-20 mb-12 blog-type res_funrai">
                    <h3 class="text_22">{{get_phrase('Complete')}}</h3>
                {{-- </div>
            </div> --}}
            <!-- Single Blog Card -->
                <div class="row">
                        ...
                        <div class="blog-card fund_card">
                            <div class="card fc_card custom_card">
                                <div class="card-img h-auto">
                                    ...
                                    @endif
                                    <div class="donate_card_1">
                                        <a class="d-flex justify-content-center w-100" href="javascript:void(0)" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                        ...
                                        <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="dropdown-item btn btn-primary btn-sm h-auto mt-0"
                                                    onclick="confirmAction('<?php echo route('explore.delete', ['id' => $row->id]); ?>')">
                                                    <i class="fa fa-trash me-1"></i>
                                                    {{get_phrase('Delete')}}
                                                </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-raised-area d-flex justify-content-between">
                                        ...
                                        <p class="pera_text">{{get_phrase('Goal :')}} <span class="text_green">{{ currency($goal_amount) }}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
