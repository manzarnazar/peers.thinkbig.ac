    ...
    <div class="col-md-12">
        <div class="col-lg-12 ">
            <div class="bg-white radius-8 p-20 mb-12  blog-type res_funrai ">
                   <div class="d-flex align-items-center justify-content-between">
                      <h3 class="text_16">{{get_phrase('Fundraiser')}}</h3>
        ...
        <div class="bg-white radius-8 p-20 mb-12 blog-type res_funrai">
            <div class="category-area">
                @if (isset($type))
                    {{-- <div class="mb-12 category-title d-flex justify-content-between bg-white radius-8 p-3 align-items-center">
                        <h3 class="text_22">{{get_phrase('Categories')}}</h3>
                        <a href="{{ route('fundraiser.create') }}" class="btn_1">{{get_phrase('Create Fundraise')}}</a>
                    </div> --}}
                    <ul class="category-list">
                        @foreach ($category as $row)
                            <a href="{{ route('fundraiser.category', $row->id) }}">
                                <li class="single-category ct_single_l">
                ...
                @else
                   @if(count($campaign_by_category) > 0)
                    <div class="col-lg-12 d-flex justify-content-between blog-type custom_margin mb-0">
                        <h3 class="text_22">{{ $section_head }} {{get_phrase('campaign')}}</h3>
                    </div>
                    <div class="col-12 ">
