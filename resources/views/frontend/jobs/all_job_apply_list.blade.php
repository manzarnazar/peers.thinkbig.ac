<div class="product-form new_job_f  mb-3 bg-white p-3 pb-12 radius-8">
    <div class="nm_place njob d-flex pagetab-head border-none  align-items-center justify-content-between" >
        ...
        <div class="btn-inline ">
            <a href="{{route('create.job')}}" class="btn_1 @if(Route::currentRouteName() == 'create.job') primary @else dash @endif "> <i class="fa fa-circle-plus me-2"></i>{{ get_phrase('Create Job') }}</a>
        </div>
    </div>
    ...
    <table class="table table-borderless">
        ...
        <tbody>
                ...
                @php                  
                 ...
                 @endphp
                <tr class="single-row table-light light-row job_ow " id="id-{{$list->id}}">
                    <th scope="row">
                    ...
                    <td>
                        <div class="single-cell ">
                            <a href="{{route('job.single.details', $list->job_id)}}" target="_blank" class="cell-item item">
                                <p>{{$job_info->title}}</p>
                                <p class="company">{{$job_info->company}}</p>
                            </a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="single-cell">
                            <div class="cell-item">
                                <a href="{{route('job.pdf.download', ['id' => $list->id])}}" target="_blank" class="btn download_btns  btn-primary"><i class="fa-solid fa-upload"></i></a>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="single-cell">
                            <div class="cell-item">
                                <a href="javascript:void(0)" onclick="confirmAction('<?php echo route('job.apply.list-delete', ['id' => $list->id]); ?>', true)" class="btn trash"><i class="fa-solid fa-trash"></i></a>
                            </div>
                        </div>
                    </td>
                </tr>
