    ...
    <div class="row">
        <div class="col-md-12 d-flex flex-column align-items-center">
            ...
            <div class="mb-3 mt-4 flex-grow-1">
                <button type="submit" class="btn common_btn text-white w-100 btn-payment-redirect"><i
